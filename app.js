...
function profileFields(data){
 ...
 const dayoff=value?(Array.isArray(e[value])?e[value].map(v=>userLabel(v,'ไม่ระบุวัน')).join(', '):userLabel(e[value],'ไม่ระบุวัน')):'ยังไม่มีข้อมูลวันหยุดประจำสัปดาห์จากระบบ';
